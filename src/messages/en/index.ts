export const messages = {
  USER_INVALID_CREDENTIALS: 'Wrong email and password combination',
  USER_CONFLICT_ERROR: 'User with same email already exists',
  TEAM_NOT_FOUND: 'Team not found',
  FORGOTPASSWORD_SUCCESS: 'Please follow the instructions sent to your email to reset your password',
